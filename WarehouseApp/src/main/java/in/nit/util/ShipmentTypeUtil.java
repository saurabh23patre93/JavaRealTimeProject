...
public class ShipmentTypeUtil {
	...
	public void generatePieChart(String location,
		...
		for(Object[] ob:list) {
			//Key -SHipmentMode ,value-count value
		...
		chart=ChartFactory.createPieChart("SHIPMENT TYPE MODE", dataset);
	...
	public void generateBarChart(String location,
		...
		//b. Convert Dataset data into JFreeChart object using ChartFactory class
		chart=ChartFactory.createBarChart("SHIPMENT TYPE MODE","SHIPMENT TYPES", "COUNT", dataset);
